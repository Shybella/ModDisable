...
public class EntityEventHandler implements Listener
{
	...
	{		
		if(!ModDisable.instance.config_enforcementWorlds.contains(explodeEvent.getLocation().getWorld().getName())) return;
		
		if(ModDisable.instance.config_protectSurfaceFromExplosions)
		{
	...
	public void onEntityDamage (EntityDamageEvent event)
	{
		...
		if(player != null)
		{
			...
			{
				event.setCancelled(true);
				player.sendMessage("Sorry, usage of that item is disabled.  Reason: " + bannedInfo.reason);				
			}
		}
	}
}
